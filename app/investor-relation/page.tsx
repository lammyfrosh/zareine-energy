          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-2">
            <Reveal>
              <div className="space-y-6 text-lg leading-8 text-gray-300">
                <p>
                  Zarein Energy offers investors access to a diversified
                  portfolio of gas-to-power and embedded infrastructure projects
                  positioned for scale, resilience and long-term value creation.
                </p>
