            ...
            <div className="mt-12 grid gap-12 lg:grid-cols-2 lg:items-center">
              <Reveal>
                <div className="space-y-6 text-lg leading-8 text-gray-700">
                  ...
                  <p>
                    The company is positioned to deliver reliable power
                    solutions through structured project development, bankable
                    partnerships, efficient generation technology and long-term
                    operational excellence.
                  </p>
                  <p>
                    With a growing portfolio spanning embedded power, gas
                    processing and infrastructure-led developments, Zarein
                    Energy is building the next generation of dependable power
                    assets for Nigeria.
                  </p>
                </div>
              </Reveal>
            ...
            <Reveal>
              <div className="max-w-3xl">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-700">
                  ...
                  people operations capability to support reliable infrastructure
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {teamMembers.map((member, index) => (
                <Reveal key={member.name} delay={index * 0.05}>
                  <div className="hover-lift h-full rounded-[1.75rem] border border-[rgba(13,47,79,0.08)] bg-white p-7 shadow-[0_18px_50px_rgba(13,47,79,0.08)]">
