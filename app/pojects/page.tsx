            ...
            {projects.map((project, index) => (
              <Reveal key={project.title} delay={index * 0.07}>
                <div className="hover-lift rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-gray-200">
                  <div className="inline-flex rounded-2xl bg-[var(--z-blue-soft)] px-4 py-2 text-sm font-semibold text-[var(--z-navy)]">
                    Project
                  </div>
                  <h2 className="mt-5 text-2xl font-semibold text-[var(--z-navy)]">
                    {project.title}
                  </h2>
