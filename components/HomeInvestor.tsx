        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="/investor-relations" className="rounded-full bg-[var(--z-blue)] px-6 py-3 text-sm font-semibold text-[var(--z-navy)] transition hover:opacity-90">View Investor Page</a>
              <a href="mailto:invest@zareinenergy.com" className="rounded-full border border-white px-6 py-3 text-sm font-semibold text-white transition hover:bg-white hover:text-[var(--z-navy)]">invest@zareinenergy.com</a>
            </div>
          </div>
        </Reveal>
        <Reveal delay={0.1}>
          <div className="hover-lift rounded-[2rem] border border-white/10 bg-white/10 p-8 backdrop-blur-md">
            <h3 className="display-font text-3xl font-semibold">Investment Highlights</h3>
