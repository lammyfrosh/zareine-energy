...
export default function HomeInvestor() {
  return (
    <section className="bg-[var(--z-dark)] py-24 text-white">
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              ...
              className="rounded-full bg-[var(--z-blue)] px-6 py-3 text-sm font-semibold text-[var(--z-dark)] transition hover:opacity-90"
            >
              View Investor Page
            </a>
