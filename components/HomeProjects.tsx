...
export default function HomeProjects() {
  return (
    <section className="page-shell relative overflow-hidden bg-[var(--z-blue-pale)] py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <Reveal delay={0.08}>
          <div className="mt-12 overflow-hidden rounded-[2rem] shadow-[0_20px_80px_rgba(15,23,42,0.12)] ring-1 ring-black/5">
            <img
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {projects.map((project, index) => (
            <Reveal key={project.title} delay={index * 0.08}>
              <div className="hover-lift rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-gray-200 transition hover:shadow-xl">
